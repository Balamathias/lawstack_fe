  ...
  return (
    <div className='flex flex-col gap-6 animate-fade-in max-w-7xl mx-auto'>
      ...
      <Card className="border-secondary/40 bg-card/50 backdrop-blur-sm overflow-hidden border shadow-lg relative">
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-12 md:w-64 h-64 bg-gradient-to-br from-primary/5 to-primary/10 rounded-full translate-x-1/3 -translate-y-1/3 blur-3xl"></div>
