...
const OpenChatButton = ({ course, user }: Props) => {
  ...
  return (
    <Button
        ...
        onClick={handleClick}
        disabled={isPending}
        className="relative bg-white/10 dark:bg-white/10 backdrop-blur-md border border-white/20 dark:border-white/20 hover:bg-white/20 dark:hover:bg-white/20 text-white dark:text-white shadow-xl hover:shadow-2xl gap-2 transition-all duration-300 ease-out hover:scale-105 active:scale-95 rounded-xl overflow-hidden group"
    >
