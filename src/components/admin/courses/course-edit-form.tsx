...
import { useUpdateCourse, useCourse } from "@/services/client/courses";
...
const CourseEditForm = ({ courseId }: CourseEditFormProps) => {
  ...
  if (isErrorCourse || !courseData?.data) {
    return (
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col items-center justify-center text-center space-y-4">
            ...
            <div>
              <h3 className="text-lg font-medium">Failed to load course</h3>
              <p className="text-sm text-muted-foreground mt-1">
                The course you are trying to edit could not be found or loaded.
              </p>
            </div>
