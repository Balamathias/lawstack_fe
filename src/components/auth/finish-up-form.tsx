...
const FinishUpForm = async ({ searchParams }: FinishUpFormProps) => {
  ...
  return (
    <div className='w-full flex flex-col gap-y-5 max-w-4xl mx-auto p-1 md:p-2.5 py-6 animate-fade-in'>
        <ProgressIndicator currentStep={step} />
        
        <div className="flex flex-col items-center justify-center gap-y-6 p-1.5 md:p-5 backdrop-blur-sm border border-border rounded-xl w-full shadow-lg bg-card/70 relative overflow-hidden animate-slide-in-up pb-10">
